...
const debug = require('debug')('booksapi:test:integration:updateBook'); // eslint-disable-line no-unused-vars
...
describe('updateBook', function() {
  ...
  it('should update a book', async function() {
    ...
    const requestOptions = {
      method: 'POST',
      url: `${apiRootUrl}/book/${bookUuid}/update`,
      data: {
        name: chance.sentence(),
        releaseDate: Date.now(),
        authorName: chance.name()
  ...
  it('should create a 404 error', function() {
    const requestOptions = {
      method: 'POST',
      url: `${apiRootUrl}/book/badbookuuid/update`,
      data: {
        uuid: 'badbookuuid',
        name: chance.sentence(),
        releaseDate: Date.now(),
