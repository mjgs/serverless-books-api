...
const putItemDbAdapterMock = proxyquire('../../../../lib/adapters/db/putItem', stubs);
...
describe('putItem', () => {
  it('should return a book object', async () => {
    ...
    // run
    const putItemResult = await putItemDbAdapterMock(tableNameMock, paramsMock, queryOptionsMock);
  ...
  it('should throw an error', async () => {
    ...
    // run
    try {
      await putItemDbAdapterMock(tableNameMock, paramsMock, queryOptionsMock);
    }
    catch (err) {
      // test
